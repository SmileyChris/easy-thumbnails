...
class Settings(AppSettings):
    ...
    THUMBNAIL_POSTPROCESS = { 'png': None, 'jpg': None, 'gif': None }
    """
    Postprocess thumbnails of type PNG, GIF or JPG after transformation but before storage.
    ...
    Example: THUMBNAIL_POSTPROCESS = {
        'png': '/usr/bin/optipng {filename}',
        'gif': '/usr/bin/optipng {filename}',
        'jpg': '/usr/bin/jpegoptim --quiet {filename}'
    }
