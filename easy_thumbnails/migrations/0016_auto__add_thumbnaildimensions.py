...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'easy_thumbnails_thumbnaildimensions', (
            ...
            ('thumbnail', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dimensions', to=orm['easy_thumbnails.Thumbnail'])),
    ...
    models = {
        ...
        u'easy_thumbnails.thumbnaildimensions': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'thumbnail': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dimensions'", 'to': u"orm['easy_thumbnails.Thumbnail']"}),
